...
public class Renderer implements GLEventListener {
	...
	private void setLight(GL2 gl, float x, float y, float z) {
		l.setX(x);
		l.setY(y);
		l.setZ(z);
		l.calculateLampPosInEyeSpace(mViewMatrix); // you need to call it if you change view matrix
		System.out.println("Light configurated");
	}
	...
	public void display(GLAutoDrawable glAutoDrawable) {
		...
		bindMatrices(gl2);
		// sending lamp position to fragment shader
		gl2.glUniform3f(shaderProgram.u_LightPosLocation, l.mLightPosInEyeSpace[0], l.mLightPosInEyeSpace[1], l.mLightPosInEyeSpace[2]);
