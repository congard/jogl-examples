...
import example.congard.jogl.shaders.sllightingadstexlp.attenuation.objmodels.ShaderProgram.Lamps;
...
public class Renderer implements GLEventListener {
	...
	private float eyeX = 0, eyeY = 0, eyeZ = 32, // положение камеры / camera position
	...
	public void init(GLAutoDrawable glAutoDrawable) {
		...
		cube = new ModelObject(loadModel(new File("./resources/models/cube.obj")), TextureUtils.loadTexture(gl2, new File("./resources/textures/cube.jpg")));
		...
		lamps = new Lamp[] {
				createLamp(24, 0, 24).setColor(1, 0, 0).setDiffuseStrength(1).setSpecularStrength(0.1f).setShininess(16).setAttenuationTerms(1, 0.045f, 0.0075f), // red lamp, rotating around z axis
				createLamp(-24, 0, 24).setColor(0, 1, 0).setDiffuseStrength(1).setSpecularStrength(0.2f).setShininess(32).setAttenuationTerms(1, 0.045f, 0.0075f), // green lamp, rotating around x axis
				createLamp(0, 0, -48).setColor(0, 0, 1).setDiffuseStrength(1).setSpecularStrength(0.3f).setShininess(64).setAttenuationTerms(1, 0.045f, 0.0075f), // blue lamp, rotating around y axis
				createLamp(0, 0, 0).setColor(1, 1, 1).setDiffuseStrength(1).setSpecularStrength(0.3f).setShininess(64).setAttenuationTerms(1, 0.045f, 0.0075f) // white lamp, rotating around y axis
		};
	...
	public void display(GLAutoDrawable glAutoDrawable) {
		...
		// drawing cubes >>
		gl2.glBindTexture(GL2.GL_TEXTURE_2D, cube.texture);
		int i;
		...
		// drawing lamps >>
		gl2.glBindTexture(GL2.GL_TEXTURE_2D, lamp.texture);
